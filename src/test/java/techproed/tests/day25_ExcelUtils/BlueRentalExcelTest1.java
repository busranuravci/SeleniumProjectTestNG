...
public class BlueRentalExcelTest1 {
    ...
    public void excelTest() {
        ...
        blueRentalPage.email.sendKeys(email, Keys.TAB,password,Keys.ENTER);  //Excel'den aldığımız verileri sendKeys() methodu ile gönderdik
